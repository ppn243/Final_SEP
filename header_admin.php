...
<header>
  <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #2A2254;">
    <div class="container-fluid">
      <a class="navbar-brand pl-5" href="#">
        <div style="border-radius:10px; background-color:white;">
          <img src="./imag/vnuk.jpg" alt="" class="d-inline-block align-text-top" height="40">
        </div>
      </a>
      <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link active text-white" aria-current="page" href="admin_contact.php">Contact</a>
            </li>
            <li class="nav-item">
              <a class="nav-link text-white" href="admin_edit.php">Edit</a>
            </li>
          </ul>
          <form class="d-flex">
            <input class="form-control mr-5" type="search" placeholder="Search" aria-label="Search" style="border-radius: 20px">
