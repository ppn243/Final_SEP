        ...
        <div class="row">
            ...
            <div class="col-4">
                ...
                <div class="mt-3" style="border:hidden; background-color: #8E0D34">
                    ...
                    <p style="text-align: center; color:white">Khoa học Dữ liệu</p>
                    <hr style="border:0,">
                    <p style="text-align: center; color:white">Quản trị và Kinh doanh quốc tế</p>
                    <hr style="border:0,">
                    <p style="text-align: center; color:white">Quản trị Kinh doanh Số</p>
                    <hr style="border:0,">
                    <p style="text-align: center; color:white">Phân tích Marketing</p>
                    <hr style="border:0,">
                    <p style="text-align: center; color:white">Công nghệ Nano</p>
                    <hr style="border:0," class="pb-5">
                </div>
                <img class="img-fluid pt-3" src="./imag/pic3.jpg" alt="#">
            </div>
        </div>
    </div>
