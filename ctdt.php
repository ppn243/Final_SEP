...
<body>
    ...
    <div class="container my-5">
        <div class="col-12">
            <h3 style="color:#2A2254; text-align:center">Cấu trúc chương trình</h3>
            <p style="font-size: 20px;text-align:center">Cấu trúc chương trình đào tạo khóa 2021-2025</p>
            <table class="table" style="background-color:#D9D9D9">
                <tbody>
                    <tr class="row">
                        <td class="col-8" style="color:#737276; text-align:center; font-weight:bold">Khối kiến thức</td>
                        <td class="col-4" style="color:#737276; text-align:center; font-weight:bold">Tín chỉ</td>
                    </tr>
                    <tr class="row">
                        <td class="col-8" style="color:#737276; text-align:center">Kiến thức chung</td>
                        <td class="col-4" style="color:#737276; text-align:center">41</td>
                    </tr>
                    <tr class="row">
                        <td class="col-8" style="color:#737276; text-align:center">Kiến thức cơ sở ngành</td>
                        <td class="col-4" style="color:#737276; text-align:center">31</td>
                    </tr>
                    <tr class="row">
                        <td class="col-8" style="color:#737276; text-align:center">Kiến thức chuyên ngành</td>
                        <td class="col-4" style="color:#737276; text-align:center">60</td>
                    </tr>
                    <tr class="row">
                        <td class="col-8" style="color:#737276; text-align:center">Thực tập và đồ án tốt nghiệp</td>
                        <td class="col-4" style="color:#737276; text-align:center">20</td>
                    </tr>
                    <tr class="row">
                        <td class="col-8" style="color:#737276; text-align:center; font-weight:bold">Tổng cộng</td>
                        <td class="col-4" style="color:#737276; text-align:center; font-weight:bold">152</td>
                    </tr>
                </tbody>
            </table>
            <ul>
                <li>
                    <p style="font-size: 20px;"><span style="font-weight:bold;">Năm 1:</span> Sinh viên được trang bị vốn tiếng Anh chuyên ngành và những kĩ năng mềm cần thiết, chuẩn bị cho những năm tiếp theo.</p>
                </li>
                <li>
                    <p style="font-size: 20px;"><span style="font-weight:bold;">Năm 2:</span> Sinh viên được học khối kiến thức nền tảng và các kỹ thuật cốt lõi của ngành.</p>
                </li>
                <li>
                    <p style="font-size: 20px;"><span style="font-weight:bold;">Năm 3:</span> Sinh viên được đào sâu vào kiến thức ngành cùng với các chuyên gia từ các doanh nghiệp như LogiGear, NovaHub, Gameloft, CodeGym… Sau đó sinh viên tham gia thực tập 6 tháng tại các doanh nghiệp trong ngành để hiểu rõ hơn về thực tế ngành và vận dụng kiến thức đã học vào các dự án thực tế.</p>
                </li>
                <li>
                    <p style="font-size: 20px;"><span style="font-weight:bold;">Năm 4:</span> Sinh viên quay lại trường để học sâu vào các học phần chuyên ngành theo hướng đi của mình và vận dụng tất cả các kiến thức đã học ở trường, tại doanh nghiệp để hoàn thành đồ án tốt nghiệp.</p>
                </li>
            </ul>
